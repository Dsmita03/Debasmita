          ...
          {!showForm ? (
            ...
            <form onSubmit={onSubmit}>
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <VStack spacing={5} p={{base:"0",md:"8"}} bg={{base:"#121212",md:"#2c2c2c"}} borderRadius="lg">
                  <Input placeholder="Name" size="lg" name="name" bg="#424242" color="#FFFFFF" border="none" focusBorderColor="#28969c"   autoComplete="off"/>
                  <Input placeholder="Email" type="email" size="lg" name="email" bg="#424242" color="#FFFFFF" border="none" focusBorderColor="#28969c" autoComplete="off"/>
                  <Textarea placeholder="Message" size="lg" name="message" bg="#424242" color="#FFFFFF" border="none" focusBorderColor="#28969c" autoComplete="off"/>
